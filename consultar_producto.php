...
<style>
    /* Nueva Paleta: Esmeralda elegante + Menta / Verde vibrante */
    :root {
        --color-primario: #064e3b; /* Verde esmeralda muy profundo y formal */
        --color-vivido: #059669;   /* Verde menta/esmeralda vibrante */
        --bg-sutil: #f0fdf4;       /* Fondo con un sutil toque verdoso limpio */
    }
    ...
    .btn-vivido:hover {
        background-color: #047857 !important; /* Tono un poco más oscuro para el hover */
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-sm btn-outline-success me-1" data-bs-toggle="modal" data-bs-target="#modalEditar<?= $p['id'] ?>">
                            Editar
                        </button>
